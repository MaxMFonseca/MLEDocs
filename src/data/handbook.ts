...
const handbookGroupsUnvalidated = [
	...
	group('renderer-system', 'systems', 'Renderer', 6, [
		...
		{ pageId: 'frame-vulkan-and-queues', slug: 'systems/renderer/frame-vulkan-and-queues', title: 'Frame, Vulkan, and queues', kind: 'system', emphasis: 'focused', subsystem: 'renderer' },
		{ pageId: 'renderer-resources-and-synchronization', slug: 'systems/renderer/resources-and-synchronization', title: 'Resources and synchronization', kind: 'system', emphasis: 'focused', subsystem: 'renderer' },
		{ pageId: 'shaders-and-pipelines', slug: 'systems/renderer/shaders-and-pipelines', title: 'Shaders and pipelines', kind: 'system', emphasis: 'focused', subsystem: 'renderer' },
		{ pageId: 'targets-text-and-composition', slug: 'systems/renderer/targets-text-and-composition', title: 'Targets, text, and composition', kind: 'system', emphasis: 'focused', subsystem: 'renderer' },
	]),
	group('models-system', 'systems', 'Models and animation', 7, [
		{ pageId: 'models', slug: 'systems/models', title: 'Models', kind: 'system', emphasis: 'overview', subsystem: 'models' },
		{ pageId: 'loading-meshes-and-materials', slug: 'systems/models/loading-meshes-and-materials', title: 'Loading meshes and materials', kind: 'system', emphasis: 'focused', subsystem: 'models' },
		{ pageId: 'animation-skeletons-and-cameras', slug: 'systems/models/animation-skeletons-and-cameras', title: 'Animation, skeletons, and cameras', kind: 'system', emphasis: 'focused', subsystem: 'models' },
	]),
	group('renderer-guides', 'guides', 'Renderer and model guides', 8, [
		{ pageId: 'create-a-shader-and-pipeline', slug: 'guides/create-a-shader-and-pipeline', title: 'Create a shader and pipeline', kind: 'guide', emphasis: 'focused', subsystem: 'renderer' },
		{ pageId: 'upload-and-render-a-model', slug: 'guides/upload-and-render-a-model', title: 'Upload and render a model', kind: 'guide', emphasis: 'focused', subsystem: 'models' },
		{ pageId: 'control-camera-and-animation', slug: 'guides/control-camera-and-animation', title: 'Control camera and animation', kind: 'guide', emphasis: 'focused', subsystem: 'models' },
	]),
	group('renderer-reference', 'reference', 'Renderer reference', 9, [
		{ pageId: 'renderer-and-resource-contracts', slug: 'reference/renderer-and-resource-contracts', title: 'Renderer and resource contracts', kind: 'reference', emphasis: 'lookup', subsystem: 'renderer', ownerPageId: 'renderer-overview' },
	]),
	group('lua-system', 'systems', 'Lua runtime', 10, [
		{ pageId: 'lua', slug: 'systems/lua', title: 'Lua runtime', kind: 'system', emphasis: 'overview', subsystem: 'lua' },
		{ pageId: 'runtime-calls-and-bindings', slug: 'systems/lua/runtime-calls-and-bindings', title: 'Runtime calls and bindings', kind: 'system', emphasis: 'deep', subsystem: 'lua' },
	]),
	group('ui-system', 'systems', 'UI', 11, [
		{ pageId: 'ui', slug: 'systems/ui', title: 'UI', kind: 'system', emphasis: 'overview', subsystem: 'ui' },
		{ pageId: 'entities-hierarchy-and-layout', slug: 'systems/ui/entities-hierarchy-and-layout', title: 'Entities, hierarchy, and layout', kind: 'system', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'rendering-and-visuals', slug: 'systems/ui/rendering-and-visuals', title: 'Rendering and visuals', kind: 'system', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'text-input-and-focus', slug: 'systems/ui/text-input-and-focus', title: 'Text input and focus', kind: 'system', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'ui-events-and-callbacks', slug: 'systems/ui/events-and-callbacks', title: 'Events and callbacks', kind: 'system', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'scrolling-and-popups', slug: 'systems/ui/scrolling-and-popups', title: 'Scrolling and popups', kind: 'system', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'animation-and-effects', slug: 'systems/ui/animation-and-effects', title: 'Animation and effects', kind: 'system', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'reusable-components', slug: 'systems/ui/reusable-components', title: 'Reusable components', kind: 'system', emphasis: 'deep', subsystem: 'ui' },
	]),
	group('ui-guides', 'guides', 'UI guides', 12, [
		{ pageId: 'build-a-ui-screen', slug: 'guides/build-a-ui-screen', title: 'Build a UI screen', kind: 'guide', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'create-a-reusable-ui-component', slug: 'guides/create-a-reusable-ui-component', title: 'Create a reusable UI component', kind: 'guide', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'build-a-form-and-handle-input', slug: 'guides/build-a-form-and-handle-input', title: 'Build a form and handle input', kind: 'guide', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'add-scrolling-and-popups', slug: 'guides/add-scrolling-and-popups', title: 'Add scrolling and popups', kind: 'guide', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'animate-and-style-ui', slug: 'guides/animate-and-style-ui', title: 'Animate and style UI', kind: 'guide', emphasis: 'deep', subsystem: 'ui' },
		{ pageId: 'use-sprites-images-and-nine-slice', slug: 'guides/use-sprites-images-and-nine-slice', title: 'Use sprites, images, and nine-slice', kind: 'guide', emphasis: 'deep', subsystem: 'ui' },
	]),
	group('ui-reference', 'reference', 'Lua and UI reference', 13, [
		{ pageId: 'lua-api', slug: 'reference/lua-api', title: 'Lua API', kind: 'reference', emphasis: 'lookup', subsystem: 'lua', ownerPageId: 'lua' },
		{ pageId: 'ui-element-keys', slug: 'reference/ui-element-keys', title: 'UI element keys', kind: 'reference', emphasis: 'lookup', subsystem: 'ui', ownerPageId: 'ui' },
		{ pageId: 'ui-components', slug: 'reference/ui-components', title: 'UI components', kind: 'reference', emphasis: 'lookup', subsystem: 'ui', ownerPageId: 'ui' },
		{ pageId: 'ui-events-and-callbacks-reference', slug: 'reference/ui-events-and-callbacks', title: 'UI events and callbacks', kind: 'reference', emphasis: 'lookup', subsystem: 'ui', ownerPageId: 'ui' },
		{ pageId: 'ui-layout-values', slug: 'reference/ui-layout-values', title: 'UI layout values', kind: 'reference', emphasis: 'lookup', subsystem: 'ui', ownerPageId: 'ui' },
	]),
	group('ui-tools', 'tools', 'UI tools', 14, [
		{ pageId: 'ui-test', slug: 'tools/ui-test', title: 'UI Test', kind: 'tool', emphasis: 'deep', subsystem: 'ui' },
	]),
