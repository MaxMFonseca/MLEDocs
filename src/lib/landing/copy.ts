...
export const landingCopy: Readonly<Record<Locale, LandingCopy>> = {
	en: {
		...
		header: { homeLabel: 'MLE documentation home', navigationLabel: 'Documentation and source links', languageLabel: 'Language', versionLabel: 'Documentation version', themeLabel: 'Theme', themeAuto: 'Auto', themeLight: 'Light', themeDark: 'Dark', sourceLabel: 'GitHub', xPlaceholderLabel: 'X (coming soon)' },
		...
		evidence: { eyebrow: 'Snapshot evidence', title: 'Documentation tied to one source state', summary: 'This handbook records an in-development snapshot instead of a moving branch.', snapshot: 'Selected snapshot', commitDate: 'Commit date', status: 'Status', source: 'Inspect the full commit' },
	...
	'pt-br': {
		...
		header: { homeLabel: 'Página inicial da documentação do MLE', navigationLabel: 'Links da documentação e do código-fonte', languageLabel: 'Idioma', versionLabel: 'Versão da documentação', themeLabel: 'Tema', themeAuto: 'Automático', themeLight: 'Claro', themeDark: 'Escuro', sourceLabel: 'GitHub', xPlaceholderLabel: 'X (em breve)' },
		...
		evidence: { eyebrow: 'Evidência do snapshot', title: 'Documentação vinculada a um estado do código-fonte', summary: 'Este manual registra um snapshot em desenvolvimento, e não um branch em movimento.', snapshot: 'Snapshot selecionado', commitDate: 'Data do commit', status: 'Estado', source: 'Inspecionar o commit completo' },
